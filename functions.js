...
const functions = [
  ...
  {
    name: 'getPlanPrices',
    description: 'Get available plans and prices information available in OneChat',
    ...
    // - device: WhatsApp number device information provided the by OneChat API
